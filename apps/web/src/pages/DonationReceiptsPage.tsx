...
export function DonationReceiptsPage() {
  ...
  return <div className="page-enter">
    ...
    <section className="invoice-summary-bar donation-summary-bar"><span><small>筛选票据数</small><strong>{query.data?.summary.count ?? 0} 张</strong></span><i /><span><small>筛选票据总金额</small><strong>{formatMoney(query.data?.summary.amount)}</strong></span></section>
